...
> We decided to keep the internal versioning to reflect that history and maturity.  
>  
> So while **v3.2** is the first version available to everyone, it already builds on multiple earlier cycles of development and testing.
---
